...
const MMR_DIFF_POINTS = [
	{threshold: -9999,  win: 45,    draw: 33,   loss: -1,   cleanSheet: 13, twoGoalAdv: 7,  twoGoalDef: -1, abandon: -15, soloKeeperGoalDef: -1},
	{threshold: -1000,  win: 43,    draw: 30,   loss: -3,   cleanSheet: 13, twoGoalAdv: 7,  twoGoalDef: -1, abandon: -15, soloKeeperGoalDef: -1},
	{threshold: -900,   win: 41,    draw: 27,   loss: -5,   cleanSheet: 13, twoGoalAdv: 7,  twoGoalDef: -1, abandon: -15, soloKeeperGoalDef: -1},
	{threshold: -800,   win: 39,    draw: 24,   loss: -7,   cleanSheet: 13, twoGoalAdv: 7,  twoGoalDef: -1, abandon: -15, soloKeeperGoalDef: -1},
	{threshold: -700,   win: 37,    draw: 21,   loss: -9,   cleanSheet: 11, twoGoalAdv: 6,  twoGoalDef: -2, abandon: -15, soloKeeperGoalDef: -2},
    {threshold: -600,   win: 35,    draw: 18,   loss: -11,  cleanSheet: 11, twoGoalAdv: 6,  twoGoalDef: -2, abandon: -15, soloKeeperGoalDef: -2}, 
    {threshold: -500,   win: 33,    draw: 15,   loss: -13,  cleanSheet: 11, twoGoalAdv: 6,  twoGoalDef: -2, abandon: -15, soloKeeperGoalDef: -2},    
    {threshold: -400,   win: 31,    draw: 12,   loss: -15,  cleanSheet: 9,  twoGoalAdv: 5,  twoGoalDef: -3, abandon: -15, soloKeeperGoalDef: -3},
    {threshold: -300,   win: 29,    draw: 9,    loss: -17,  cleanSheet: 9,  twoGoalAdv: 5,  twoGoalDef: -3, abandon: -15, soloKeeperGoalDef: -3},
    {threshold: -200,   win: 27,    draw: 6,    loss: -19,  cleanSheet: 9,  twoGoalAdv: 5,  twoGoalDef: -3, abandon: -15, soloKeeperGoalDef: -3},
    {threshold: -100,   win: 25,    draw: 3,    loss: -21,  cleanSheet: 7,  twoGoalAdv: 4,  twoGoalDef: -4, abandon: -15, soloKeeperGoalDef: -4},
    {threshold: 100,    win: 23,    draw: 0,    loss: -23,  cleanSheet: 7,  twoGoalAdv: 4,  twoGoalDef: -4, abandon: -15, soloKeeperGoalDef: -4},
    {threshold: 200,    win: 21,    draw: -3,   loss: -25,  cleanSheet: 7,  twoGoalAdv: 4,  twoGoalDef: -4, abandon: -15, soloKeeperGoalDef: -4},
    {threshold: 300,    win: 19,    draw: -6,   loss: -27,  cleanSheet: 5,  twoGoalAdv: 3,  twoGoalDef: -5, abandon: -15, soloKeeperGoalDef: -5},
    {threshold: 400,    win: 17,    draw: -9,   loss: -29,  cleanSheet: 5,  twoGoalAdv: 3,  twoGoalDef: -5, abandon: -15, soloKeeperGoalDef: -5},
    {threshold: 500,    win: 15,    draw: -12,  loss: -31,  cleanSheet: 5,  twoGoalAdv: 3,  twoGoalDef: -5, abandon: -15, soloKeeperGoalDef: -5},    
    {threshold: 600,    win: 13,    draw: -15,  loss: -33,  cleanSheet: 3,  twoGoalAdv: 2,  twoGoalDef: -6, abandon: -15, soloKeeperGoalDef: -6},
    {threshold: 700,    win: 11,    draw: -18,  loss: -35,  cleanSheet: 3,  twoGoalAdv: 2,  twoGoalDef: -6, abandon: -15, soloKeeperGoalDef: -6},
    {threshold: 800,    win: 9,     draw: -21,  loss: -37,  cleanSheet: 3,  twoGoalAdv: 2,  twoGoalDef: -6, abandon: -15, soloKeeperGoalDef: -6},
    {threshold: 900,    win: 7,     draw: -24,  loss: -39,  cleanSheet: 1,  twoGoalAdv: 1,  twoGoalDef: -7, abandon: -15, soloKeeperGoalDef: -7}, 
    {threshold: 1000,   win: 5,     draw: -27,  loss: -41,  cleanSheet: 1,  twoGoalAdv: 1,  twoGoalDef: -7, abandon: -15, soloKeeperGoalDef: -7},
    {threshold: 1100,   win: 3,     draw: -30,  loss: -43,  cleanSheet: 1,  twoGoalAdv: 1,  twoGoalDef: -7, abandon: -15, soloKeeperGoalDef: -7},
    {threshold: 9999,   win: 1,     draw: -33,  loss: -45,  cleanSheet: 1,  twoGoalAdv: 1,  twoGoalDef: -7, abandon: -15, soloKeeperGoalDef: -7}
];
